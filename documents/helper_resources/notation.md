<!-- 
Style guide:
    this file must contain a description of all shortnames and symbols used across the document. 

    It also must specify across the various schematics which shape correspond to which logic element.

    Be aware that it must only provide the complete name, not any description since those are handled by the glossary.
-->
