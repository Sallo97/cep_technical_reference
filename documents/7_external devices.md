...
- **Photoelectric sensor (*lettori fotoelettrici* in italian)**: A photoelectric sensor is a device used to determine the distance, absence, or presence of an object by using a light transmitter, often infrared, and a photoelectric receiver. 
...
- **Perforatori veloci**: **NOT CONFIRMED, THIS IS MY THEORY**: used for writing punched tape for storing data or programs produced by the CEP.
